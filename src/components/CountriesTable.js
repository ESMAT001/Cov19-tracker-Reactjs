...
function CountriesTable({ handleCountryChange, data }) {
    const perPage = 10;
                ...
                <tbody className="divide-y divide-blue-700 divide-opacity-75">

                    {
                        slicedData.map((country) => {
                            ...
                            return (
                                <tr className="divide-x divide-blue-700 divide-opacity-75 transition duration-300 ease-in-out cursor-pointer hover:bg-blue-700 hover:bg-opacity-20" key={countryCode + countryName}>
